...
export enum InvoiceLineItemsApiApiKeys {
    tokenAuth,
}
...
export class InvoiceLineItemsApi {
    ...
    public setApiKey(key: InvoiceLineItemsApiApiKeys, value: string) {
        (this.authentications as any)[InvoiceLineItemsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async invoiceLineItemsRetrieve (xAccountToken: string, id: string, includeRemoteData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InvoiceLineItem;  }> {
        const localVarPath = this.basePath + '/invoice-line-items/{id}'
        ...
        if (xAccountToken === null || xAccountToken === undefined) {
            throw new Error('Required parameter xAccountToken was null or undefined when calling invoiceLineItemsRetrieve.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling invoiceLineItemsRetrieve.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InvoiceLineItem;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "InvoiceLineItem");
