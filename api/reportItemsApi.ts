...
export enum ReportItemsApiApiKeys {
    tokenAuth,
}

export class ReportItemsApi {
    ...
    public setApiKey(key: ReportItemsApiApiKeys, value: string) {
        (this.authentications as any)[ReportItemsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async reportItemsRetrieve (xAccountToken: string, id: string, includeRemoteData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReportItem;  }> {
        const localVarPath = this.basePath + '/report-items/{id}'
        ...
        if (xAccountToken === null || xAccountToken === undefined) {
            throw new Error('Required parameter xAccountToken was null or undefined when calling reportItemsRetrieve.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling reportItemsRetrieve.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ReportItem;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ReportItem");
