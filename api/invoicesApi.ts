...
export class InvoicesApi {
     ...
     * @param xAccountToken Token identifying the end user.
     */
    public async invoicesMetaPostRetrieve (xAccountToken: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetaResponse;  }> {
        ...
        // verify required parameter 'xAccountToken' is not null or undefined
        if (xAccountToken === null || xAccountToken === undefined) {
            throw new Error('Required parameter xAccountToken was null or undefined when calling invoicesMetaPostRetrieve.');
        }
