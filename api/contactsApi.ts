...
export class ContactsApi {
     ...
     * @param includeRemoteData Whether to include the original data Merge fetched from the third-party to produce these models.
     */
    public async contactsRetrieve (xAccountToken: string, id: string, expand?: 'addresses' | 'addresses,phone_numbers' | 'phone_numbers', includeRemoteData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Contact;  }> {
