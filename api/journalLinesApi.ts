...
export enum JournalLinesApiApiKeys {
    tokenAuth,
}
...
export class JournalLinesApi {
    ...
    public setApiKey(key: JournalLinesApiApiKeys, value: string) {
        (this.authentications as any)[JournalLinesApiApiKeys[key]].apiKey = value;
    }
    ...
    /**
     * Returns a `JournalLine` object with the given `id`.
     ...
     */
    public async journalLinesRetrieve (xAccountToken: string, id: string, includeRemoteData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: JournalLine;  }> {
        const localVarPath = this.basePath + '/journal-lines/{id}'
        ...
        if (xAccountToken === null || xAccountToken === undefined) {
            throw new Error('Required parameter xAccountToken was null or undefined when calling journalLinesRetrieve.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling journalLinesRetrieve.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: JournalLine;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "JournalLine");
